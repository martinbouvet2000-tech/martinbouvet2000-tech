...
<p align="center">
  <picture>
    ...
    <img src="assets/card-light.svg" alt="neofetch-style card: business student at emlyon, AI-native builder, live GitHub stats" width="100%" />
  </picture>
</p>
...
|---|---|---|
| **[Nous Deux](https://github.com/martinbouvet2000-tech/nous-deux)** | Private app for long-distance couples: dual time zones, real-time shared map, shared calendar with PDF/Excel import, time capsules, Web Push. React, TypeScript, Supabase (row-level security on every table, Edge Functions), CI on every push. | [demo](https://nous-deux-pi.vercel.app) |
...
- **Capture pipelines.** Saved Instagram posts are transcribed and filed as structured, scored idea notes automatically.
...
- Building an **e-invoicing readiness audit** for French small businesses ahead of the 2026 reform.
- First year of the **Global BBA at emlyon**, Lyon, after studying **LLMs, generative and agentic AI at Oxford**.
- Open to talking about AI automation for small businesses.
...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/martinbouvet2000-tech/martinbouvet2000-tech/output/snake-light.svg" alt="Contribution graph being eaten by a snake" width="100%" />
</picture>

<sub>The card above rebuilds itself every day from the GitHub API (<code>scripts/build_card.py</code>, run by a GitHub Action). No third-party stats service.</sub>
